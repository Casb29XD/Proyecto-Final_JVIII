    ...
    private void eliminarEmpleado() {
        ...
        if(empleadoSeleccionado != null){
            if(mostrarMensajeConfirmacion("¿Estas seguro de elmininar al empleado?")){
                empleadoEliminado = empleadoControllerService.eliminarEmpleado(Integer.parseInt(empleadoSeleccionado.cedula()));
    ...
    private void actualizarEmpleado() {
        ...
        if(empleadoSeleccionado != null){
            ...
            if(datosValidos(empleadoSeleccionado)){
                clienteActualizado = empleadoControllerService.actualizarEmpleado(Integer.parseInt(cedulaActual),empleadoDto);
